<template>
  ...
  <div class="flex flex-col justify-center items-center px-4 py-12 bg-gray-50 min-h-screen mb-24">
  ...
  <form class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl bg-white p-8 rounded-lg shadow-md">
    ...
    <div class="flex flex-col">
      <label for="email" class="text-sm font-medium text-gray-700 mb-1">Confirm Password</label>
